		...
		<div class="container">
			<div class="row">
				...
				<div class="inlineCopy col-xs-12 col-sm-6">
					<div class="copy">&copy; <?= date('Y') ?> - <a href="https://koeln-webstudio.de/" target="_blank" style="text-decoration: underline;">Köln Webstudio</a> - erfolgreiche Webprojekte</div>
				</div>
				<div class="inlineImp clerfix col-xs-12 col-sm-4">
					...
					<?php } ?>
					<a href="https://modetoday.de/datenschutz/" class="impressum-btn">datenschutz |&nbsp;</a>
					<a href="https://modetoday.de/impressum/" class="impressum-btn">impressum</a>
				</div>
			</div>
