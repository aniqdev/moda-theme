...
<head>
	...
	<?php if(is_singular( 'fashion' )): ?>
		<link rel="amphtml" href="<?= ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>?amp">
		<meta name="description" content="Finden Sie Top-Angebote für <?= get_the_title() ?> auf Modetoday. Günstige Preise. Moderne Damenmode.">
	<?php endif; ?>
	<?php kw_js_variables(); ?>
	<?php wp_head(); ?>
